...
function Hero({ title, description, links }: { title: string, description: string, links?: Array<{ type: keyof ButtonStylesType, text: string, prefixIcon?: keyof IconMapType, postfixIcon?: keyof IconMapType }> }): React.ReactNode {
    return (
